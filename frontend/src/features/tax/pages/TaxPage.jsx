...
import {
  ...
  getTDSRecords,
  getTaxProjection
} from '@/core/api/taxApi';
import TaxDetailsForm from '@/features/tax/components/TaxDetailsForm';
import RegimeComparison from '@/features/tax/components/RegimeComparison';
import CapitalGainsTracker from '@/features/tax/components/CapitalGainsTracker';
import TDSManagement from '@/features/tax/components/TDSManagement';
import TaxProjection from '@/features/tax/components/TaxProjection';
import './TaxPage.css';
