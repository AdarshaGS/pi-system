...
class SavingsAccountControllerIntegrationTest extends BaseApiTest {
        ...
        void testCreateSavingsAccount() {
                ...
                ApiAssertions.assertFieldValue(response, "amount", 50000);
        ...
        void testCreateDuplicateSavingsAccount() {
                ...
                Map<String, Object> savingsData = TestDataBuilder.createSavingsAccountData(
                                userId, "ICICI Bank", 25000);
                authHelper.getAuthenticatedSpec().body(savingsData).post("/api/v1/savings-accounts");
        ...
        void testGetAllSavingsAccounts() {
                ...
                Map<String, Object> savings1 = TestDataBuilder.createSavingsAccountData(
                                userId, "SBI Bank", 30000);
                Map<String, Object> savings2 = TestDataBuilder.createSavingsAccountData(
                                userId, "Axis Bank", 40000);

                authHelper.getAuthenticatedSpec().body(savings1).post("/api/v1/savings-accounts");
                authHelper.getAuthenticatedSpec().body(savings2).post("/api/v1/savings-accounts");
        ...
        void testGetNonExistentSavingsAccount() {
                ...
                Response response = authHelper.getAuthenticatedSpec()
                                .when()
                                .get("/api/v1/savings-accounts/999999");

                // Then
                ApiAssertions.assertStatusCode(response, 404);
                response.then()
                                .body("message", containsString("SAVINGS_ENTITY_NOT_FOUND"));
        }
        ...
        void testUpdateSavingsAccount() {
                ...
                // Update amount
                savingsData.put("amount", 25000);

                // When
                Response response = authHelper.getAuthenticatedSpec()
                                .body(savingsData)
                                .when()
                                .put("/api/v1/savings-accounts/" + accountId);

                // Then
                ApiAssertions.assertStatusCode(response, 200);
                ApiAssertions.assertFieldValue(response, "amount", 25000);
        }
        ...
        void testDeleteSavingsAccount() {
                ...
                Response response = authHelper.getAuthenticatedSpec()
                                .when()
                                .delete("/api/v1/savings-accounts/" + accountId);
