package com.stocks.thirdParty.providers.AlphaVantage;
...
import com.stocks.thirdParty.providers.AlphaVantage.data.AlphaVantageResponseOverview;
...
public class AlphaVantageProvider implements StockDataProvider {
    ...
    private ThirdPartyResponse mapToThirdPartyResponse(AlphaVantageResponseOverview av) {
        ...
        // Map Market Cap
        try {
            long mc = Long.parseLong(av.getMarketCapitalization());
