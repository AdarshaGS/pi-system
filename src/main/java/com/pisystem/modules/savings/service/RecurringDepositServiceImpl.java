...
import com.pisystem.modules.savings.exception.DuplicateSavingsEntityException;
import com.pisystem.modules.savings.exception.SavingsEntityNotFoundException;
...
public class RecurringDepositServiceImpl implements RecurringDepositService {
    ...
    private final com.pisystem.shared.security.AuthenticationHelper authenticationHelper;
    ...
    public RecurringDepositDTO createRecurringDeposit(RecurringDeposit recurringDeposit) {
        authenticationHelper.validateUserAccess(recurringDeposit.getUserId());
