...
public class TaxController {
    ...
    @Operation(
        ...
        description = "Compare old vs new tax regime and get recommendations based on income and deductions"
    )
    ...
    @Operation(
        summary = "Record capital gains transaction",
        description = "Record a capital gains transaction and auto-calculate STCG/LTCG tax"
    )
    ...
    @Operation(
        summary = "Get capital gains summary",
        description = "Get comprehensive capital gains summary with STCG/LTCG breakdown"
    )
    ...
    @Operation(
        summary = "Get capital gains transactions",
        description = "List all capital gains transactions for a financial year"
    )
    ...
    @Operation(
        summary = "Calculate capital gains",
        description = "Calculate capital gains and tax for a transaction (preview without saving)"
    )
    ...
    @Operation(
        summary = "Get tax saving recommendations",
        description = "Get personalized tax saving recommendations based on income and current investments"
    )
    ...
    @Operation(
        summary = "Record tax saving investment",
        description = "Record a tax saving investment (80C, 80D, etc.)"
    )
    ...
    @Operation(
        summary = "Get tax saving investments",
        description = "List all tax saving investments for a financial year"
    )
    ...
    @Operation(
        summary = "Record TDS entry",
        description = "Record a TDS deduction entry with deductor details"
    )
    ...
    @Operation(
        summary = "Get TDS entries",
        description = "List all TDS entries for a financial year"
    )
    ...
    @Operation(
        summary = "Get TDS reconciliation",
        description = "Get TDS reconciliation report with verification status and recommendations"
    )
    ...
    @Operation(
        summary = "Update TDS status",
        description = "Update the verification status of a TDS entry"
    )
    ...
    @Operation(
        summary = "Get tax projection",
        description = "Get tax projection for current financial year with month-wise recommendations"
    )
    ...
    @Operation(
        summary = "Get ITR pre-fill data",
        description = "Export comprehensive data for ITR filing with all income, deductions, and tax details"
    )
